...
function initiate_single_arm_kinematic_stuff() {
    ...
    var armText = new THREE.TextureLoader().load("../models/lazer_sprite_2.png");
...
function gen_boxes() {
    var text = new THREE.TextureLoader().load("../models/box.jpg");
...
function setup_room_walls() {
    var groundTexture = new THREE.TextureLoader().load("../models/floor_full.png");
